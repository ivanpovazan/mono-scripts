...
#Example: DOTNET_VERSION=7.0.100-preview.7.22354.2
DOTNET_VERSION=
if [ -z "$1" ]; then
    echo "Pass the dotnet version you would like to get the download URL for example './get-dotnet-pkg-url.sh 7.0.100-preview.7.22354.2'"
    exit 1
else
    DOTNET_VERSION=$1
fi
